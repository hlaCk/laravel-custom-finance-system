...
<!--          <div class="w-1/5 py-4">-->
<!--            <label class="inline-block text-80 pt-2 leading-tight">{{ __('novaMenuBuilder.menuItemEndPoint') }}</label>-->
<!--          </div>-->

<!--          <div class="py-4 w-4/5">-->
<!--            <input-->
<!--              :placeholder="__('novaMenuBuilder.menuItemEndPoint')"-->
<!--              :class="{ 'border-danger': getError('end_point') }"-->
<!--              class="w-full form-control form-input form-input-bordered"-->
<!--              id="end_point"-->
<!--              type="text"-->
<!--              v-model="newItem.end_point"-->
<!--            />-->

<!--            <help-text class="error-text mt-2 text-danger" v-if="getError('end_point')">-->
<!--              {{ getError('end_point') }}-->
<!--            </help-text>-->
<!--          </div>-->
<!--        </div>-->
