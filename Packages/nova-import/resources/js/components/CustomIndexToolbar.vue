...
export default {
    ...
    methods: {
        ...
        getActions() {
            ...
            // console.log('ni-getActions',this.selectedAction,this)
            return Nova.request()
                .get(`/nova-api/${this.resourceName}/actions`, {
                    params: {
                        component: 'nova-import',
        ...
        executeAction() {
            this.working = true
            //console.log('ni-executeAction',this)
            Nova.request({
                method: 'post',
        ...
        actionFormData() {
            return _.tap(new FormData(), formData => {
                formData.append('component', 'nova-import')
                // formData.append('_resourceId', this.selectedResources === 'all' ? 0 : this.selectedResources)
                // formData.append('_resourceName', this.resourceName)
    ...
    computed: {
        ...
        actionRequestQueryString() {
            ...
            let _viaResource = _route.viaResource || undefined;
            let _viaResourceId = _route.viaResourceId || undefined;
            let _viaRelationship = _route.viaRelationship || undefined;

            return {
                _parentResourceId: _viaResourceId,
                _parentResourceName: _viaResource,
                _parentRelationship: _viaRelationship,
