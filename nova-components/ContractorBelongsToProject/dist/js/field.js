...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__FieldProject__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__FieldEntryCategory__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__FieldContractor__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_laravel_nova__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_laravel_nova___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_laravel_nova__);
...
/* harmony default export */ __webpack_exports__["a"] = ([{
    ...
    mounted: function mounted() {
        ...
        this.$once('hook:beforeDestroy', function () {
            _this.removeChangeListener();
        });
    },

    methods: {
        registerChangeListener: function registerChangeListener() {
            $_debug && this.$on('project-changed', function (v) {
                return console.warn('init: ', 'project-changed: ', v);
            });
            $_debug && this.$on('entry_category-changed', function (v) {
                return console.warn('init: ', 'entry_category-changed: ', v);
            });
    ...
    computed: {
        data: {
            get: function get() {
                var $data = {};
                for (var option in Array.from(this.field.options || [])) {
                    var _option = this.field.options[option];
...
}, __WEBPACK_IMPORTED_MODULE_4_laravel_nova__["FormField"], __WEBPACK_IMPORTED_MODULE_4_laravel_nova__["HandlesValidationErrors"], __WEBPACK_IMPORTED_MODULE_1__FieldProject__["a" /* default */], __WEBPACK_IMPORTED_MODULE_2__FieldEntryCategory__["a" /* default */], __WEBPACK_IMPORTED_MODULE_3__FieldContractor__["a" /* default */], overrideMethods]);
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    computed: {
        displayValue: function displayValue() {
            return this.field.displayUsingLabels ? _.find(this.field.options, { value: this.field.value }).label : this.field.value;
        }
    },
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                return _context.abrupt('return', Nova.request().post('/nova-vendor/update-order/updateOrder/' + this.resourceName + '/' + this.resourceId, formData).then(function (response) {
                                    var label_message = "FAILED!";

                                    if (response.data.success) {
                                        var label = _.find(_this.field.options, function (option) {
                                            return option.value == _this.value;
                                        }).label;
                                        label_message = _this.field.name + ' updated to "' + label + '"';
                                    }

                                    _this.$toasted.show(label_message, { type: response.data.success ? 'success' : 'error' });
...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-contractor-belongs-to-project', __webpack_require__(8));
  Vue.component('detail-contractor-belongs-to-project', __webpack_require__(16));
  Vue.component('form-contractor-belongs-to-project', __webpack_require__(19));
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mixins_init__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mixins_inline__ = __webpack_require__(5);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    mixins: [__WEBPACK_IMPORTED_MODULE_1_laravel_nova__["FormField"], __WEBPACK_IMPORTED_MODULE_1_laravel_nova__["HandlesValidationErrors"], __WEBPACK_IMPORTED_MODULE_3__mixins_inline__["a" /* default */]].concat(_toConsumableArray(__WEBPACK_IMPORTED_MODULE_2__mixins_init__["a" /* default */])),
    ...
    methods: {
         ...
         * @deprecated
         */
        attemptUpdated: function attemptUpdated() {
            var _this = this;

            this.submit(); //.then(x=>this.getResources());
            setTimeout(function () {
                return _this.reloadResources();
            }, 500);
        },
         ...
         * @return {Promise<void>}
         */
        reloadResourcesd: function () {
            var _ref = _asyncToGenerator( /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.mark(function _callee() {
                var filters_backup, filters_to_change;
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                ...
                                filters_backup = _.cloneDeep(this.$store.getters[this.resourceName + '/filters']);
                                filters_to_change = _.cloneDeep(filters_backup);

                                filters_to_change.push({});
                                _context.next = 6;
                                return this.$store.commit(this.resourceName + '/storeFilters', filters_to_change);
            ...
            function reloadResourcesd() {
                return _ref.apply(this, arguments);
            }

            return reloadResourcesd;
        }()
    }
});
...
var $_debug = __WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].debug_mode && __WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].field_types.project;
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    methods: {
        initProjectField: function initProjectField() {
            var _this2 = this;

            var projects_interval = setInterval(function () {
                if (_this2.project_field) {
                    if (_this2.getProjectId()) {
                        projects_interval && clearInterval(projects_interval);
                        projects_interval = 0;
                        _this2.$emit('project-changed', _this2.getProjectId());
                        _this2.handleProjectChange(_this2.getProjectId());
                    }
                } else {
                    projects_interval && clearInterval(projects_interval);
                    projects_interval = 0;
                    _this2.$emit('project-changed', undefined);
                    _this2.handleProjectChange(_this2.getProjectId());
                }
            }, 10);
        ...
        getProjectId: function getProjectId() {
            ...
            var project_field = this.project_field || 'project',
        ...
        handleProjectChange: function handleProjectChange(v) {
        ...
        registerProjectListener: function registerProjectListener() {
            var _this3 = this;

            $_debug && console.warn('FieldProject: ', 'registerProjectListener');
            Nova.$on('project-change', function (e) {
                _this3.handleProjectChange(e);

                // this.field.value = this.value
            });
        },
        removeProjectListener: function removeProjectListener() {
    ...
    computed: {
        ...
        project_field: function project_field() {
    ...
    watch: {
        selectedProjectIda: function selectedProjectIda(n, o) {
            if (n !== o) {
...
var $_debug = __WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].debug_mode && __WEBPACK_IMPORTED_MODULE_1__config__["a" /* default */].field_types.entry_category;
...
/* harmony default export */ __webpack_exports__["a"] = ({
                ...
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            ...
                            this.loadEntryCategories().then(this.initEntryCategoryField);
    ...
    mounted: function mounted() {
        ...
        this.$once('hook:beforeDestroy', function () {
            _this.removeEntryCategoryListener();
        });
    },
    ...
    methods: {
        initEntryCategoryField: function initEntryCategoryField() {
            var _this2 = this;

            var entry_categories_interval = setInterval(function () {
                if (_this2.entry_category_field) {
                    if (_this2.getEntryCategoryId()) {
                        entry_categories_interval && clearInterval(entry_categories_interval);
                        _this2.$emit('entry_category-changed', _this2.getEntryCategoryId());
                        _this2.handleEntryCategoryChange(_this2.getEntryCategoryId());
                    }
                } else {
                    entry_categories_interval && clearInterval(entry_categories_interval);
                    _this2.$emit('entry_category-changed', undefined);
                    _this2.handleEntryCategoryChange(_this2.getEntryCategoryId());
                }
            }, 10);
        ...
        loadEntryCategories: function loadEntryCategories() {
            var _this3 = this;
            ...
            return Nova.request().get('/api/entry_category/only_has_contractors/ids', { params: {} }).then(function (res) {
                return res.data;
            }).then(function (res) {
                var data = res.data;

                _this3.entry_categories = data;
                _this3.handleEntryCategoryChange(_this3.getEntryCategoryId());
                return data;
            }).catch(function (error) {
        ...
        getEntryCategoryId: function getEntryCategoryId() {
            var cb = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : undefined;
            ...
            if (this.entry_category_field) {
                var element = document.querySelector('[dusk=\'' + this.entry_category_field + '\']');
                result = element && element.value;
            }
            return cb(result);
        },
        isEntryCategoryHasConstructors: function isEntryCategoryHasConstructors() {
            return this.entry_category_has_constructor = this.entry_category_field ? this.entry_categories.includes(Number(this.getEntryCategoryId())) : false;
        },
        handleEntryCategoryChange: function handleEntryCategoryChange(v) {
        ...
        registerEntryCategoryListener: function registerEntryCategoryListener() {
        ...
        removeEntryCategoryListener: function removeEntryCategoryListener() {
            $_debug && console.warn('FieldEntryCategory: ', 'removeEntryCategoryListener');
            Nova.$off('entry_category-change');
        }
    },
    computed: {
        entry_category_field: function entry_category_field() {
            return this.field.entry_category_field;
        }
    },
    watch: {
        entry_categoriesa: function entry_categoriesa() {
            var _this4 = this;

            setTimeout(function () {
                _this4.$emit('entry_category-changed', _this4.entry_category_has_constructor = _this4.isEntryCategoryHasConstructors());

                _this4.handleEntryCategoryChange(_this4.getEntryCategoryId());

                $_debug && console.warn('FieldEntryCategory: ', 'watch:entry_categories', {
                    entry_category_has_constructor: _this4.entry_category_has_constructor,
                    isEntryCategoryHasConstructors: [_this4.isEntryCategoryHasConstructors, _this4.isEntryCategoryHasConstructors()],
                    getEntryCategoryId: [_this4.getEntryCategoryId, _this4.getEntryCategoryId()],
                    entry_category_field: _this4.entry_category_field,
                    entry_categories: _this4.entry_categories,
                    includes: _this4.entry_categories.includes(Number(_this4.getEntryCategoryId()))
                });
            }, 10);
        }
    }
...
var $_debug = __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].debug_mode && __WEBPACK_IMPORTED_MODULE_0__config__["a" /* default */].field_types.contractor;
var lastUrl = ['', '', ''];
var reloadContractorsTimeOutId = 0;
/* harmony default export */ __webpack_exports__["a"] = ({
    created: function created() {
        lastUrl = ['', '', ''];
    ...
    methods: {
        registerChangeListener: function registerChangeListener() {
            ...
            this.$on('contractor_id-change', function (e) {
                _this2.handleChange(e);
                console.error('FieldContractor: registerChangeListener: contractor_id-change', e, _this2.value);
            });
            this.$on('contractor_id-changed', function (e) {
                _this2.handleChange(e);
                console.error('FieldContractor: registerChangeListener: contractor_id-changed', e, _this2.value);
            });
            this.$on('contractor_id-value', function (e) {
                _this2.handleChange(e);
                console.error('FieldContractor: registerChangeListener: contractor_id-value', e, _this2.value);
            });
        ...
        forceReloadContractors: function forceReloadContractors() {
            lastUrl[2] = '';
        ...
        reloadContractors: function reloadContractors() {
            var _this3 = this;
            ...
            reloadContractorsTimeOutId = setTimeout(function () {
                reloadContractorsTimeOutId = 0;
                _this3.getContractors();
            }, 10);
        },
        getContractors: function getContractors() {
            ...
            var $getProjectId = function $getProjectId() {
                return _this4.selectedProject || _this4.getProjectId();
            };
            lastUrl[0] = '/nova-vendor/components/contractor-belongs-to-project/data';
            lastUrl[1] = {
                project_id: $getProjectId()
            };
            var fullUrl = lastUrl[0] + '?';
            var paramCount = Object.values(lastUrl[1]).filter(function (v) {
                return Number(v);
            }).length;

            Object.keys(lastUrl[1]).map(function (k) {
                return fullUrl = fullUrl + (k + '=' + lastUrl[1][k] + '&');
            });

            if (lastUrl[2] && lastUrl[2] === fullUrl) {
                if (!paramCount) {
                    setTimeout(function () {
                        _this4.getContractors();
                    }, 100);
                }
            ...
            return Nova.request().get(lastUrl[0], {
                params: lastUrl[1]
            }).then(function (res) {
                return res.data;
            }).then(function (res) {
                var _res$data = res.data,
                    data = _res$data.data,
                    project_id = _res$data.project_id;

                if (Number(project_id) !== Number($getProjectId())) {
                    _this4.forceReloadContractors();
                    return false;
                }

                _this4.field.options = data;
                _this4.initEntryCategoryField();
                return data;
            }).catch(function (error) {
                console.error(error.response.status, error);
            }).finally(function () {
    ...
    computed: {
        contractor_name: function contractor_name() {
            return this.field.options[this.value];
        }
    },
    watch: {
        selectedProject: function selectedProject(n, o) {
            if (n !== o) {
                console.error(' --------- ');
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mixins_init__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mixins_inline__ = __webpack_require__(5);
function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    mixins: [__WEBPACK_IMPORTED_MODULE_0_laravel_nova__["FormField"], __WEBPACK_IMPORTED_MODULE_0_laravel_nova__["HandlesValidationErrors"], __WEBPACK_IMPORTED_MODULE_2__mixins_inline__["a" /* default */]].concat(_toConsumableArray(__WEBPACK_IMPORTED_MODULE_1__mixins_init__["a" /* default */])),
...
/* harmony default export */ __webpack_exports__["default"] = ({
    mixins: [__WEBPACK_IMPORTED_MODULE_0_laravel_nova__["FormField"], __WEBPACK_IMPORTED_MODULE_0_laravel_nova__["HandlesValidationErrors"]].concat(_toConsumableArray(__WEBPACK_IMPORTED_MODULE_1__mixins_init__["a" /* default */])),
    props: ["resourceName", "resourceId", "field"],

    methods: {
        hanlder: function hanlder(v) {
            ...
            [
              _c(
                "select-control",
                {
                  ...
                  class: [
                    { hidden: !_vm.entry_category_has_constructor },
                    _vm.errorClasses
                  ],
                  attrs: {
