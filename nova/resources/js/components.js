...
import NovaQuickSearch from '@/components/NovaQuickSearch'

Vue.component("nqs-vue-single-select", SelectAutoCompleteField)
Vue.component("nova-quick-search", NovaQuickSearch)
