...
class InstallCommand extends Command
{
    ...
    public function handle()
    {
        ...
        copy($this->resolveStubPath('/stubs/nova/user-resource.stub'), app_path('Nova/Info/User.php'));

        if (file_exists(app_path('Models/Info/User.php'))) {
            file_put_contents(
                app_path('Nova/Info/User.php'),
                str_replace('App\User::class', 'App\Models\Info\User::class', file_get_contents(app_path('Nova/Info/User.php')))
            );
        }
    ...
    protected function setAppNamespace()
    {
        ...
        $this->setAppNamespaceOn(app_path('Nova/Info/User.php'), $namespace);
