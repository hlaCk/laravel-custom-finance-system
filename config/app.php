...
return [
    ...
    'media_collection_multiple_video_name' => env('MEDIA_COLLECTION_MULTIPLE_VIDEO_NAME', 'media_videos'),
    'media_collection_single_video_name'   => env('MEDIA_COLLECTION_SINGLE_VIDEO_NAME', 'media_video'),

    'media_collection_thumb'     => 'thumb',
    'media_collection_full-size' => 'full-size',

    'media_collection_name'              => env('MEDIA_COLLECTION_SINGLE_IMAGE_NAME', 'media_image'),
