...
return [
     ...
     */
    'locales'                 => config('nova.locales', []),//['en' => 'English','ar' => 'العربية'],
     ...
     * locale.
     *
     * Set to locale key (`en`, `ru`, etc) or null to enable/disable or true to use current language.
     */
    'fill_other_locales_from' => true,
