...
return [
    ...
    */
    ...
    'menu_item_types' => [
        \App\Nova\MenuBuilderTypes\NavLinkType::class,
        \App\Nova\MenuBuilderTypes\MenuItemStaticURLType::class,
        \App\Nova\MenuBuilderTypes\MenuItemTextType::class,
        \App\Nova\MenuBuilderTypes\StaticDropdownType::class,
        \App\Nova\MenuBuilderTypes\DynamicDropdownType::class,
    ],
